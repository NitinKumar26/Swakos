...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HelperMethods.loadFragment(new HomeFragment(), MainActivity.this);
    }
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            try{
                ...
                HelperMethods.CURRENT_POSTAL_CODE = addresses.get(0).getPostalCode();
                //txtLocationResult.setText(HelperMethods.LOCATION);
                //Log.e("currentLocation", HelperMethods.LOCATION);
    ...
    BottomNavigationView.OnNavigationItemSelectedListener listener = item -> {
        switch (item.getItemId()){
            case R.id.action_profile:
                HelperMethods.loadFragment(new ProfileFragment(), MainActivity.this);
                return true;
